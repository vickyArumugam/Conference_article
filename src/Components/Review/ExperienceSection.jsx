...
const ExperienceSection = () => {
  ...
  return (
    <div className="w-4/5 mx-auto flex flex-col md:flex-row items-center justify-center py-16 px-6 md:px-20 bg-white gap-10">
      ...
      <div className="md:w-1/2 md:pl-16 text-center md:text-left mt-8 md:mt-0">
        ...
        <p className="w-[88%] text-gray-700 mt-4 text-base sm:text-lg md:text-xl leading-relaxed text-justify ">
