          ...
          <div className="space-y-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 leading-relaxed">
                {journal.name} is a leading peer-reviewed journal in the field of {journal.category}. 
                We publish groundbreaking research, comprehensive reviews, and cutting-edge methodologies 
                that advance the understanding of {journal.category.toLowerCase()}.
              </p>
            </div>
          </div>
        );
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-medium text-gray-900 mb-2">Manuscript Preparation</h4>
                ...
                <div>
                  <h4 className="font-medium text-gray-900 mb-2">Submission Requirements</h4>
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-medium text-gray-900 mb-2">Editorial Office</h4>
                  <p className="text-gray-600">Email: editorial@{journal.name.toLowerCase().replace(/\s+/g, '')}.com</p>
                  <p className="text-gray-600">Phone: +1 (555) 123-4567</p>
                </div>
                <div>
                  <h4 className="font-medium text-gray-900 mb-2">Technical Support</h4>
                  <p className="text-gray-600">Email: support@{journal.name.toLowerCase().replace(/\s+/g, '')}.com</p>
                </div>
              </div>
            </div>
          </div>
